...
` +
  ...
  var ie = lt(($e, ne) => {
    "use strict";
    var ee = gt();
    ee.define("brand", (ne.exports = function () {}), function (e) {
      var y = {},
        l = document,
        T = e("html"),
        C = e("body"),
      ...
      y.ready = function () {
        ...
        (/\.webflow\.io$/i.test(X) && L.hostname !== X && (W = !0),
          W &&
            !_ &&
            ((B = B || P()), R(), setTimeout(R, 500), e(l).off(I, U).on(I, U)));
      };
      function U() {
        var W =
          l.fullScreen ||
            ...
            if (L) {
              ...
              ((U = b),
                Math.abs(f) > I &&
                  l &&
                  String(l()) === "" &&
                  (C("swipe", $, { direction: f > 0 ? "right" : "left" }),
                  X()));
            }
          }
          function W($) {
