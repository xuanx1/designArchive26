...
((FLIPBOOK.PageWebGL = function (t, e, i, o, s, n) {
  ...
  (0 == e &&
    ...
    (this.cornerCurlTween = new FLIPBOOK.TWEEN.Tween(0)
      ...
      .onUpdate(function (t) {
        r.cornerCurl && ((r.b2.force = -1.8 * t), r.modF.apply());
      })
      .repeat(11e3)
      .start())),
  ...
  var h = new THREE.MeshBasicMaterial({ color: 15592941 }),
    a = [h, h, h, h, s, n],
    p = [h, h, h, h, h, h];
  if (this.options.pagePreloader) p = [h, h, h, h, s, n];
  ((this.cube = new THREE.Mesh(this.gF, a)),
  ...
  (FLIPBOOK.PageWebGL.prototype.load = function (t, i) {
    ...
    if (e.wrapperH && e.zoom) {
      ...
      this.disposed = !1;
      var a = s.options.rightToLeft
          ? this.book.pages.length - this.index - 1
          : this.index,
        p = s.options.rightToLeft ? 2 * a + 1 : 2 * a,
        c = s.options.rightToLeft ? 2 * a : 2 * a + 1,
        l = n,
        d =
          e.wrapperH * e.zoom < l.pageTextureSizeTreshold
            ? l.pageTextureSizeSmall
            : l.pageTextureSize;
      "front" == t
        ? this.sizeFront == d
          ? i && i.call(this)
          : this.options.main.loadPage(p, d, function (t) {
              if (t) {
                  ...
                  ((e.image = t.image),
                    ...
                    "left" == s.options.pages[2 * s.index].side
                      ...
                      : "right" == s.options.pages[2 * s.index].side &&
                        ((e.repeat.x = 0.5), (e.offset.x = 0.5)),
                    (s.frontMaterial = s.createMaterial(e)),
        ...
        : "back" == t &&
          (this.sizeBack == d
            ? i && i.call(this)
            : this.options.main.loadPage(c, d, function (t) {
                if (t) {
                    ...
                    ((e.image = t.image),
                      ...
                      "left" == s.options.pages[2 * s.index + 1].side
                        ...
                        : "right" == s.options.pages[2 * s.index + 1].side &&
                          ((e.repeat.x = 0.5), (e.offset.x = 0.5)),
                      (s.backMaterial = s.createMaterial(e, "back")),
  ...
  (FLIPBOOK.PageWebGL.prototype.correctZOrder = function () {
    var t;
    for (this.position.z = 3, t = this.index - 1; 0 <= t; t--)
  ...
  (FLIPBOOK.PageWebGL.prototype.flipFinished = function () {
    ...
    (t.flippingLeft
      ...
      (t.flipping = !1),
      (t.dragging = !1),
      void 0 !== t.onComplete && t.onComplete(t),
      t.book.flipFinnished());
  }),
  ...
  (FLIPBOOK.BookWebGL.prototype.init3d = function () {
    ...
    ((this.Scene = new THREE.Scene()),
      ...
      (this.Camera = new THREE.PerspectiveCamera(30, t, 1, 1e4)),
    ...
    (((window.renderer = s).gammaInput = !0),
      (s.gammaOutput = !0),
      this.options.shadows &&
        ...
        if (e.rendering) {
          ...
          (FLIPBOOK.TWEEN.update(),
            e.needsUpdate &&
              ...
              (e.needsUpdate = !1),
              e.htmlLayer && e.cssRenderer.render(e.Scene, e.Camera)));
        }
        requestAnimationFrame(t);
      })());
  }),
  (FLIPBOOK.BookWebGL.prototype.onPageLoaded = function (t, e) {
  ...
  (FLIPBOOK.BookWebGL.prototype.onPageUnloaded = function (t, e) {
    ...
    ((i = this.options.rightToLeft
      ? ((o = this.pages.length - o - 1), t % 2 == 0 ? "back" : "front")
      : t % 2 == 0
        ? "front"
        : "back"),
    ...
    if (!this.isZoomed()) {
      ...
      if (
        ...
        if ("move" == e && n <= 1) {
          ...
          if (1 == this.view && this.isFocusedLeft() && "left" == i)
            return (
          ...
          (a && a.dragging) || (h && h.dragging)
            ? (h && !a) || (h && !a.dragging)
              ? o <= 0 && h._setAngle(o, i)
              : ((a && !h) || (a && !h.dragging)) && 0 <= o && a._setAngle(o, i)
            : 0 != o &&
  ...
  (FLIPBOOK.BookWebGL.prototype.createPages = function () {
    ...
    (a.addColorStop(0, "#AAAAAA"),
      a.addColorStop(1, s.pageMiddleShadowColorL),
      (h.fillStyle = a),
    ...
    (d.addColorStop(0, s.pageMiddleShadowColorR),
      d.addColorStop(1, "#AAAAAA"),
      (l.fillStyle = d),
      l.fillRect(0, 0, 64, 64));
    var u,
      f,
      g = new THREE.CanvasTexture(c);
    if (((g.needsUpdate = !0), (o.specularF = g), o.options.pagePreloader)) {
      var m = new THREE.TextureLoader().load(
        o.options.pagePreloader,
        function () {},
      );
      o.options.lights
        ...
        : (u = f = new THREE.MeshBasicMaterial({ map: m, color: 15592941 }));
    } else
      o.options.lights
        ? ((u = new THREE.MeshStandardMaterial({
            roughness: o.options.pageRoughness,
        ...
        : (u = f = new THREE.MeshBasicMaterial({ color: 15592941 }));
    var y = o.options.pages;
    for (i = 0; i < y.length / 2; i++) {
      ((t =
        0 == i || i == y.length / 2 - 1
          ? o.options.coverHardness
          : o.options.pageHardness),
        (e = new FLIPBOOK.PageWebGL(o, i, t, o.options, u, f)),
        o.pages.push(e),
        o.centerContainer.add(e),
        o.flippedright++);
      0 < i
        ? ((e.position.z = o.pages[i - 1].position.z - 2 - 2 - 1),
          this.bg && (this.bg.position.z = e.position.z - 5))
        : (e.position.z = 2);
    }
    ((o.initialized = !0), this.updateHtmlLayer());
  }),
    ...
    if (this.initialized)
      if (
        ...
        if (void 0 !== e && e) {
          ...
          else for (; o.rightIndex > t; ) this.prevPageInstant();
          return (
            this.updateBookPosition(),
            this.turnPageComplete(),
            void this.updateHtmlLayer()
          );
        }
        this.rightIndex > t
          ? ((i =
                ...
                setTimeout(function () {
                  if (void 0 !== e && e)
                    for (var t = 0; t < o.pages.length; t++)
                      o.pages[t].duration = o.options.pageFlipDuration;
                  o.turnPageComplete();
                }, i)))
          : this.rightIndex < t &&
            ((i =
  ...
  (FLIPBOOK.BookWebGL.prototype.nextPage = function (t) {
    if (
      ...
      !(
        1 == this.flippedright && 2 * this.pages.length > this.options.numPages
      ...
      var o = this.pages[this.pages.length - this.flippedright],
        s =
          (this.pages[o.index - 2],
          this.pages[o.index - 3],
          this.pages[o.index + 1]);
  ...
  (FLIPBOOK.BookWebGL.prototype.updateBookPosition = function () {
    (1 == this.view
      ? this.isFocusedLeft() && 0 < this.rightIndex
        ? this.focusLeft()
        : this.focusRight()
      : 0 == this.rightIndex
        ? this.focusRight()
  ...
  (FLIPBOOK.BookWebGL.prototype.turnPageComplete = function () {
    ...
    for (
      ...
      var s;
      (((s = t[e]) !== i && s !== o) || s.showMat(),
        o &&
          s.index < o.index - 2 &&
          (s.hideMat(), this.options.pdfMode || s.disposeMat()),
        i &&
          s.index > i.index + 2 &&
          (s.hideMat(), this.options.pdfMode || s.disposeMat()));
    }
  ...
  (FLIPBOOK.BookWebGL.prototype.loadVisiblePages = function () {
    var e = this.pages[this.flippedleft],
      t = this.pages[this.flippedleft - 1],
      i =
        (this.pages[this.flippedleft - 2],
        this.pages[this.flippedleft + 1],
        this.pages[this.flippedleft - 3],
        this.pages[this.flippedleft + 2],
        this.updateHtmlLayer),
      o = this.loadMorePages,
      s = this,
      n = (this.pages, this.options.main);
    (n.setLoadingProgress(0.1),
      t
        ? t.load("back", function (t) {
            e
              ? e.load("front", function (t) {
                  (n.setLoadingProgress(1), i.call(s), o.call(s));
                })
              : (n.setLoadingProgress(1), i.call(s), o.call(s));
          })
        : e.load("front", function (t) {
  ...
  (FLIPBOOK.BookWebGL.prototype.focusLeft = function (t, e) {
    var i = 0.5 * this.options.pageWidth * this.centerContainer.scale.x;
  ...
  (FLIPBOOK.BookWebGL.prototype.prevPage = function (t) {
    if (
      ...
      ((this.clickedPage = null),
      1 != this.flippedleft ||
        2 * this.pages.length != this.options.numPages ||
        !this.options.rightToLeft ||
  ...
  (FLIPBOOK.BookWebGL.prototype.flipFinnished = function () {
    (this.updateHtmlLayer(), (this.needsUpdate = !0));
  }),
...
(!(function (t) {
  ...
  (function (o) {
    var e = o.Constants;
    ((o.XMath = {}),
      (o.XMath.normalize = function (t, e, i) {
  ...
  (function (e) {
    ((e.Matrix = function (t, e, i, o) {
      ...
      (e.Matrix.prototype.transformPoint = function (t) {
        return new e.Point(
          this.m11 * t.x + this.m12 * t.y,
          this.m21 * t.x + this.m22 * t.y,
        );
      }));
  })(MOD3),
  (function (a) {
  ...
  (function (i) {
    ((i.VertexProxy = function (t) {
      ...
      (i.VertexProxy.prototype.setVertex = function () {}),
      (i.VertexProxy.prototype.setRatios = function (t, e, i) {
      ...
      (i.VertexProxy.prototype.getX = function () {}),
      (i.VertexProxy.prototype.getY = function () {}),
      (i.VertexProxy.prototype.getZ = function () {}),
      (i.VertexProxy.prototype.setX = function () {}),
      (i.VertexProxy.prototype.setY = function () {}),
      (i.VertexProxy.prototype.setZ = function () {}),
      (i.VertexProxy.prototype.getValue = function (t) {
        switch (t) {
  ...
  (function (m) {
    ((m.MeshProxy = function () {
      ...
      (m.MeshProxy.prototype.analyzeGeometry = function () {
        ...
        for (
          e = n - s,
            ...
            f = f(e, f(i, depth)),
            d == e && f == i
              ? ((this.minAxis = m.ModConstant.Y),
                (this.midAxis = m.ModConstant.Z),
                (this.maxAxis = m.ModConstant.X))
              : d == e && f == depth
                ? ((this.minAxis = m.ModConstant.Z),
                  (this.midAxis = m.ModConstant.Y),
                  (this.maxAxis = m.ModConstant.X))
                : d == i && f == e
                  ? ((this.minAxis = m.ModConstant.X),
                    (this.midAxis = m.ModConstant.Z),
                    (this.maxAxis = m.ModConstant.Y))
                  : d == i && f == depth
                    ? ((this.minAxis = m.ModConstant.Z),
                      (this.midAxis = m.ModConstant.X),
                      (this.maxAxis = m.ModConstant.Y))
                    : d == depth && f == e
                      ? ((this.minAxis = m.ModConstant.X),
                        (this.midAxis = m.ModConstant.Y),
                        (this.maxAxis = m.ModConstant.Z))
                      : d == depth &&
                        f == i &&
                        ((this.minAxis = m.ModConstant.Y),
                        (this.midAxis = m.ModConstant.X),
      ...
      (m.MeshProxy.prototype.collapseGeometry = function () {
        for (var t = this.getVertices(), e = t.length; 0 <= --e; )
          t[e].collapse();
      ...
      (m.MeshProxy.prototype.postApply = function () {}),
      (m.MeshProxy.prototype.updateMeshPosition = function () {}));
  })(MOD3),
  (function (t) {
    ((t.Modifier = function () {
      this.mod = null;
  ...
  (function (i) {
    ((i.ModifierStack = function (t, e) {
      ((this.lib3d = t),
        ...
        (this.baseMesh = i.PluginFactory.getMeshProxy(t)),
  ...
  (function (o) {
    ((o.Pivot = function (t, e, i) {
      ...
      (o.Pivot.prototype = new o.Modifier()),
      (o.Pivot.prototype.constructor = o.Pivot),
      (o.Pivot.prototype.setMeshCenter = function () {
        var t = this.mod;
        this.pivot = new o.Vector3(
          -(t.minX + 0.5 * t.width),
          -(t.minY + 0.5 * t.height),
          -(t.minZ + 0.5 * t.depth),
        );
  ...
  (function (P) {
    ((P.Bend = function (t, e, i) {
      ((this.diagAngle = this.angle = this.offset = this.force = null),
        (this.constraint = P.ModConstant.NONE),
        (this.m2 =
          this.m1 =
          this.origin =
          this.height =
      ...
      (P.Bend.prototype = new P.Modifier()),
      (P.Bend.prototype.constructor = P.Bend),
      (P.Bend.prototype.setAngle = function (t) {
        ((this.angle = t),
          (this.m1 = new P.Matrix()),
          this.m1.rotate(t),
          (this.m2 = new P.Matrix()),
          this.m2.rotate(-t));
      }),
      (P.Bend.prototype.setModifiable = function (t) {
        (P.Modifier.prototype.setModifiable.call(this, t),
        ...
        if (0 != this.force)
          for (
            var t,
              ...
              u = this.m2,
              f = a + r * h,
              g = r / Math.PI / this.force,
              m = P.Constants.doublePI * (r / (g * P.Constants.doublePI)),
              y = 1 / r,
              x = P.Constants.halfPI,
              M = Math.sin,
              v = Math.cos;
            0 <= --n;
          )
            ((t = (r = s[n]).getValue(p)),
              (e = r.getValue(l)),
              (i = r.getValue(c)),
              (t = (e = d.transformPoint(new P.Point(t, e))).x),
              (e = e.y),
              (o = (t - a) * y),
              (this.constraint == P.ModConstant.LEFT && o <= h) ||
                (this.constraint == P.ModConstant.RIGHT && h <= o) ||
                ((t = M((o = x - m * h + m * o)) * (g + i)),
                (o = v(o) * (g + i)),
                (i = t - g),
                (t = f - o)),
              (t = (e = u.transformPoint(new P.Point(t, e))).x),
              (e = e.y),
              r.setValue(p, t),
              r.setValue(l, e),
              r.setValue(c, i));
  ...
  (function (h) {
    ((h.Twist = function (t) {
      ((this.vector = new h.Vector3(0, 1, 0)),
        (this.angle = t),
        (this.center = h.Vector3.ZERO()));
    }),
      (h.Twist.prototype = new h.Modifier()),
      (h.Twist.prototype.constructor = h.Twist),
      (h.Twist.prototype.apply = function () {
        this.vector.normalize();
        var t,
          e = (r = this.mod).getVertices(),
          i = e.length,
          o = this.vector,
          s = this.angle,
          n = this.center,
          r =
            ...
            s;
        for (n = -h.Vector3.dot(o, n); 0 <= --i; )
          ((t = (s = e[i]).getX() * o.x + s.getY() * o.y + s.getZ() * o.z + n),
            this.twistPoint(s, t * r));
      }),
      (h.Twist.prototype.twistPoint = function (t, e) {
        var i = new h.Matrix4().translationMatrix(t.getX(), t.getY(), t.getZ());
        i = new h.Matrix4().multiply(
          new h.Matrix4().rotationMatrix(
            this.vector.x,
            this.vector.y,
            this.vector.z,
            e,
  ...
  (function (g) {
    ((g.Skew = function (t) {
      ((this.force = 0),
        (this.skewAxis = null),
        void 0 !== t && (this.force = t),
        (this.offset = 0.5),
        (this.constraint = g.ModConstant.NONE),
        (this.falloff = this.power = 1),
        (this.swapAxes = this.oneSide = this.inverseFalloff = !1));
    }),
      (g.Skew.prototype = new g.Modifier()),
      (g.Skew.prototype.constructor = g.Skew),
      (g.Skew.prototype.setModifiable = function (t) {
        (g.Modifier.prototype.setModifiable.call(this, t),
      ...
      (g.Skew.prototype.apply = function () {
        for (
          var t,
            e,
            i,
            o = this.mod.getVertices(),
            s = o.length,
            n = this.constraint,
            r = this.skewAxis,
            h = this.offset,
            a = this.oneSide,
            p = this.inverseFalloff,
            c = this.falloff,
            l = 1 - c,
            d = this.power,
            u = this.force,
            f = this.getDisplaceAxis();
          0 <= --s;
        )
          ((t = o[s]),
            !(n == g.ModConstant.LEFT && t.getRatio(r) <= h) &&
              !(n == g.ModConstant.RIGHT && t.getRatio(r) > h) &&
              ((e = t.getRatio(r) - h),
              a && (e = Math.abs(e)),
              (i = t.getRatio(f)),
              p && (i = 1 - i),
              (i = c + i * l),
              (e = Math.pow(Math.abs(e), d) * g.XMath.sign(e, 1)),
              (e = t.getValue(f) + u * e * i),
              t.setValue(f, e)));
      }),
  ...
  (function (p) {
    ((p.Taper = function (t) {
      ((this.power = this.force = null),
        (this.start = 0),
        (this.end = 1),
        (this.vector = new p.Vector3(1, 0, 1)),
        (this.vector2 = new p.Vector3(0, 1, 0)),
        void 0 !== t && (this.force = t),
        (this.power = 1));
    }),
      (p.Taper.prototype = new p.Modifier()),
      (p.Taper.prototype.constructor = p.Taper),
      (p.Taper.prototype.setFalloff = function (t, e) {
        ((this.start = 0),
          (this.end = 1),
          void 0 !== t && (this.start = t),
          void 0 !== e && (this.end = e));
      ...
      (p.Taper.prototype.apply = function () {
        for (
          ...
          ((e = (t = o[s]).getRatioVector().multiply(r)),
            (e = h * Math.pow(e.getMagnitude(), a)),
            (e = new p.Matrix4().scaleMatrix(
              1 + e * n.x,
              1 + e * n.y,
              1 + e * n.z,
            )),
            (i = t.getVector()),
            new p.Matrix4().multiplyVector(e, i),
            t.setVector(i));
      }));
  })(MOD3),
  (function (h) {
    ((h.Wheel = function () {
      ((this.radius = this.roll = this.turn = this.speed = null),
        (this.steerVector = new h.Vector3(0, 1, 0)),
        (this.rollVector = new h.Vector3(0, 0, 1)),
        (this.roll = this.turn = this.speed = 0));
    }),
      (h.Wheel.prototype = new h.Modifier()),
      (h.Wheel.prototype.constructor = h.Wheel),
      (h.Wheel.prototype.setModifiable = function (t) {
        (h.Modifier.prototype.setModifiable.call(this, t),
      ...
      (h.Wheel.prototype.apply = function () {
        ...
        for (
          r =
            0 != s
              ? ((t = new h.Matrix4().rotationMatrix(o.x, o.y, o.z, s)),
                (o = n.clone()),
                new h.Matrix4().multiplyVector(t, o),
                new h.Matrix4().rotationMatrix(o.x, o.y, o.z, r))
              : new h.Matrix4().rotationMatrix(n.x, n.y, n.z, r);
          0 <= --i;
        )
          ((n = (o = e[i]).getVector().clone()),
            0 != s && new h.Matrix4().multiplyVector(t, n),
            new h.Matrix4().multiplyVector(r, n),
            o.setX(n.x),
            o.setY(n.y),
            o.setZ(n.z));
      }),
  ...
  (function (a) {
    ((a.Break = function (t, e) {
      ((this.bv = new a.Vector3(0, 1, 0)),
        ...
        void 0 !== t && (this.offset = t),
        void 0 !== e && (this.angle = e),
      ...
      (a.Break.prototype.apply = function () {
        ...
        for (
          t = (i = new a.Vector3(
            0,
            0,
            -(i.minZ + i.depth * this.offset),
          )).negate(),
            e = new a.Matrix4().rotationMatrix(h.x, h.y, h.z, r);
          0 <= --s;
        )
          (0 <= (h = (h = (r = o[s]).getVector()).add(i)).z &&
            n.isIn(r.ratioY) &&
            new a.Matrix4().multiplyVector(e, h),
            (h = h.add(t)),
            r.setX(h.x),
            r.setY(h.y),
            r.setZ(h.z));
  ...
  (function (e) {
    ((e.Noise = function (t) {
      ...
      (e.Noise.prototype.constraintAxes = function (t) {
        this.axc = t;
      }),
  ...
  (function (h) {
    ((h.MeshThree = function () {}),
      (h.MeshThree.prototype = new h.MeshProxy()),
      (h.MeshThree.prototype.setMesh = function (t) {
        ...
        var e,
          ...
          r = n.length;
        for (i = 0; i < s; )
          ((e = new h.VertexThree(this.mesh)).setVertex(o[i]),
            this.vertices.push(e),
            (t[o[i]] = e),
            i++);
        for (i = 0; i < r; )
          ((s = new h.FaceProxy()),
            n[i] instanceof THREE.Face3
              ? (s.addVertex(t[o[n[i].a]]),
                s.addVertex(t[o[n[i].b]]),
                s.addVertex(t[o[n[i].c]]))
              : n[i] instanceof THREE.Face4 &&
                (s.addVertex(t[o[n[i].a]]),
                s.addVertex(t[o[n[i].b]]),
                s.addVertex(t[o[n[i].c]]),
                s.addVertex(t[o[n[i].d]])),
            this.faces.push(s),
            i++);
        delete lookup;
      }),
  ...
  (function (h) {
    ((h.MeshPre3D = function () {}),
      (h.MeshPre3D.prototype = new h.MeshProxy()),
      (h.MeshPre3D.prototype.setMesh = function (t) {
        h.MeshProxy.prototype.setMesh.call(this, t);
        t = [];
        for (
          var e = this.mesh.vertices,
            i = this.mesh.quads,
            o = e.length,
            s = i.length,
            n = 0;
        ...
        for (n = 0; n < s; n++)
          ((o = new h.FaceProxy()),
            i[n] instanceof Pre3d.QuadFace &&
              (o.addVertex(t[e[i[n].i0]]),
              o.addVertex(t[e[i[n].i1]]),
              o.addVertex(t[e[i[n].i2]]),
              null != i[n].i3 && o.addVertex(t[e[i[n].i3]])),
            this.faces.push(o));
        delete lookup;
      }),
  ...
  (function (n) {
    ((n.MeshJ3D = function () {}),
      (n.MeshJ3D.prototype = new n.MeshProxy()),
      (n.MeshJ3D.prototype.setMesh = function (t) {
        ...
        for (i = 0; i < o; )
          ((e = new n.VertexJ3D(t.geometry)).setVertex(i),
            this.vertices.push(e),
            (i += s));
        this.faces = null;
      }),
  ...
  (function (r) {
    ((r.MeshCopperlicht = function () {}),
      (r.MeshCopperlicht.prototype = new r.MeshProxy()),
      (r.MeshCopperlicht.prototype.setMesh = function (t) {
  ...
  (FLIPBOOK.TWEEN.Tween = function (t) {
    ...
    ((this.to = function (t, e) {
      ...
      (this.start = function (t) {
        for (var e in (FLIPBOOK.TWEEN.add(this),
        (O = !(i = !0)),
        (x = void 0 !== t ? t : window.performance.now()),
        (x += y),
        l)) {
      ...
      (this.update = function (t) {
        ...
        for (e in l) {
          ...
          n instanceof Array
            ? (p[e] = v(n, o))
            : ("string" == typeof n && (n = s + parseFloat(n, 10)),
              "number" == typeof n && (p[e] = s + (n - s) * o));
        }
        if ((null !== b && b.call(p, o), 1 != i)) return !0;
        if (0 < f) {
          for (e in (isFinite(f) && f--, d)) {
            if (
              ("string" == typeof l[e] && (d[e] = d[e] + parseFloat(l[e], 10)),
              g)
            ) {
              var r = d[e];
              ((d[e] = l[e]), (l[e] = r));
  ...
  (FLIPBOOK.CSS3DRenderer = function () {
    ...
    ((d.className = "cameraElement " + Math.random()),
    ...
    function f(t, e) {
      var i = t.elements,
        o =
          ...
          ")";
      return u
        ? "translate(-50%,-50%)translate(" + n + "px," + r + "px)" + e + o
        : "translate(-50%,-50%)" + o;
    }
      ...
      for (
        var e,
          ...
          e.traverse(function (t) {
            t instanceof FLIPBOOK.CSS3DObject && i.push(t);
          }),
          i).sort(function (t, e) {
            return (
              l.objects.get(t).distanceToCameraSquared -
              l.objects.get(e).distanceToCameraSquared
            );
          }),
          s = o.length,
          n = 0,
        ...
        o[n].element.style.zIndex = s - n;
    }
    this.render = function (t, e) {
      var i = e.projectionMatrix.elements[5] * r;
      (l.camera.fov !== i &&
        (e.isPerspectiveCamera &&
          ((h.style.WebkitPerspective = i + "px"),
          (h.style.perspective = i + "px")),
        (l.camera.fov = i)),
        t.updateMatrixWorld(),
        null === e.parent && e.updateMatrixWorld());
      var o = e.isOrthographicCamera
          ? "scale(" + i + ")" + a(e.matrixWorldInverse)
          : "translateZ(" + i + "px)" + a(e.matrixWorldInverse),
          ...
          if (e instanceof FLIPBOOK.CSS3DObject) {
            ...
            s =
              e instanceof FLIPBOOK.CSS3DSprite
                ? (c.copy(i.matrixWorldInverse),
                  c.transpose(),
                  c.copyPosition(e.matrixWorld),
                  c.scale(e.scale),
                  (c.elements[3] = 0),
                  (c.elements[7] = 0),
                  (c.elements[11] = 0),
